...
public class SqliteSqlDialect extends SqlDialect {
  ...
  @Override public void unparseCall(SqlWriter writer, SqlCall call,
    ...
    case POSITION:
      ...
      case 2:
        instrCall(call.getParserPosition(), call.operand(1), call.operand(0))
  ...
  private static SqlCall instrCall(SqlParserPos pos, SqlNode source, SqlNode search) {
    return INSTR
        .createCall(pos, source, search);
  }

  private static SqlCall substrCall(SqlParserPos pos, SqlNode source, SqlNode start) {
    return SUBSTR
        .createCall(pos, source, start);
  }
  ...
  private static SqlNode positionWithFromCall(SqlCall call) {
    ...
    final SqlNode relativePosition =
        instrCall(pos, substrCall(pos, source, start), search);
