...
public enum BuiltInMethod {
  ...
  SHORT_INTERVAL_DECIMAL_CAST_BIG_DECIMAL_ROUNDING_MODE(Primitive.class,
      "shortIntervalToDecimalCast", BigDecimal.class, int.class, int.class,
      BigDecimal.class, RoundingMode.class),
  ...
  INTERVAL_DAY_TIME_TO_STRING_BIG_DECIMAL(SqlFunctions.class,
      "intervalDayTimeToString", BigDecimal.class, TimeUnitRange.class,
      int.class),
